...
int main(int argc, char ** argv){
	...
	auto time_now = std::chrono::nanoseconds(10);
	...
	rapp::object::pose_stamped pose_mid(rapp::object::msg_metadata(0,rapp::object::time(time_now),"/map"), rapp::object::pose(rapp::object::point(1,1,0),rapp::object::quaternion(0,0,0,1))); 
	poses_list.push_back(pose_mid);
	// determine goal pose for moveAlongPath method
	rapp::object::pose_stamped pose_goal(rapp::object::msg_metadata(0,rapp::object::time(time_now),"/map"), rapp::object::pose(rapp::object::point(2,0,0),rapp::object::quaternion(0,0,0,1))); 
